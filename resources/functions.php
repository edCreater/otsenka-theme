...
add_filter( 'gkt_enqueue_plugin_object_fit_images', '__return_false' );
add_filter( 'gkt_enqueue_plugin_video_worker', '__return_false' );
add_filter( 'gkt_enqueue_plugin_swiper', '__return_false' );
add_filter( 'gkt_enqueue_plugin_gist_embed', '__return_false' );
add_filter( 'gkt_enqueue_plugin_scrollreveal', '__return_false' );

/*
 * Deffering JS for plugins
 */
